...
# 5) заявку записывать в БД: предмет, юзейрнейм, телефон (если есть в открытом доступе или юзер предоставил сам), время и дата заявки
# 6) отсылать заявку админинам в списке
# 8) добавить возможность просматривать заявки за определенный период для администраторов